...
export const HomeContainer = () => {
    ...
    return (<>
            ...
            <div className="top-section-main">
                <div className="top-section-content">
                    <div className="left-container">
                        ...
                        <a href='./' className="nav-link home-comp login-btn">SIGN UP {" >"} </a>
                    </div>
                </div>
            </div>
            <div className="feature-section">
                <h1 className="feature-section-title">How it works ? <br /> <img className="underline" src='./assets/underline.png' alt='underlinepic' /> </h1>
            </div>
            {
        ...
        <div className="try-it">
            <a className="login-btn" href="./" style={{ textAlign: 'center' }}>TRY IT FOR YOURSELF {">"} </a>
        </div>
    </>)
}
